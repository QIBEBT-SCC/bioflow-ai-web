...
export function ProjectRunHistory({ projectId }: ProjectRunHistoryProps) {
          ...
          <Table>
            <TableHeader>
              <TableRow className='bg-muted/50'>
                <TableHead className='w-[250px]'>运行名称</TableHead>
                <TableHead className='w-[120px]'>状态</TableHead>
                <TableHead className='w-[180px]'>进度</TableHead>
                <TableHead className='w-[120px]'>样本</TableHead>
                ...
                filteredRuns.map((run) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* 开始时间 */}
                      <TableCell className='text-sm'>
                        {formatDateTime(run.start_time || undefined)}
                      </TableCell>
